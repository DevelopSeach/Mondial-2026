module.exports = [
  ...
  { doc_key: 'contact', label: 'צור קשר', file_url: '', file_type: 'contact', sort_order: 50 },
  { doc_key: 'sitemap', label: 'מפת אתר', file_url: '/docs/sitemap.pdf', file_type: 'pdf', sort_order: 60 }
];
